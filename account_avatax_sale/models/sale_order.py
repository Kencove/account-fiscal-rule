...
class SaleOrder(models.Model):
        ...
        for line in self.order_line:
            ...
            if tax_result_line:
                ...
                # setting Retail Delivery Fee from avatax salestax
                    ...
                    tax = retail_delivery_fee_tax_match[0]
                # tax_amount doesn't match means creating copy with new amount
    ...
    def add_retail_product(self):
        ...
        if avatax_config:
            ...
            order_to_unlink = (
                self.order_line.filtered(lambda o: o.retail_delivery_fee) - order_line
            )
            if order_to_unlink:
                self.write({"order_line": [(2, order_to_unlink[0].id)]})
